        ...
        <div className=' flex flex-col lg:flex-row  '>
          ...
          >
            ...
            <div>
              ...
              <h3>Email Add : shalommother1@gmail.com</h3>
          ...
          <motion.form
            ...
            <input type='text' className='  h-font bg-transparent border-b py-3 outline-none w-full
             placeholder:text-white focus:border-green-500 transition-all'
              placeholder='your email' onChange={emailSetter} value={email} />
            ...
            <textarea className=' bg-transparent border-b py-6 pb-24 mb-6 outline-none w-full
             placeholder:text-white h-font focus:border-green-500 transition-all' placeholder="your messaage" onChange={messageSetter} value={message} />
